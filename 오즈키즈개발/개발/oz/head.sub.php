...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/lib/css/reset.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/lib/css/common.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/lib/css/fonts.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/lib/css/hamburgers.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/lib/css/swiper-bundle.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/layout.css?ver=1.0">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/style.css?ver=1.0">', 0);
